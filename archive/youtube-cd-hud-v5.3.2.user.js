// ==UserScript==
// @name         YouTube CD Album & HUD Overlay (with Tracklist + 1001Tracklists) v5.3.2
// @namespace    http://tampermonkey.net/
// @version      5.3.2
// @description  修復 1001Tracklists POST 搜尋、Trusted Types、換片競態、請求清理、重試按鈕與封面配色
// @author       You
...
(function () {
    ...
    if (window.trustedTypes && typeof window.trustedTypes.createPolicy === 'function') {
        try {
            remoteHtmlPolicy = window.trustedTypes.createPolicy('yt-cd-hud-v532-remote-parser', {
        ...
        activeSearchRequest = GM_xmlhttpRequest({
            ...
            onload: function (resp) {
                ...
                try {
                    ...
                    if (!is1001TracklistsUrl(resultUrl.href)) {
                        throw new Error('Unexpected search-result host.');
                    }
                    href = resultUrl.href;
                } catch (error) {
                    markSearchError('搜尋結果包含無效的 1001Tracklists 網址。', error);
                    return;
                }
                ...
                activeTracklistRequest = GM_xmlhttpRequest({
                    ...
                    onload: function (resp2) {
                        ...
                        if (tracks && tracks.length > 0) {
                            ...
                            markSearchError('1001Tracklists 頁面已載入，但找不到可解析的時間戳曲目。');
                        }
                    },

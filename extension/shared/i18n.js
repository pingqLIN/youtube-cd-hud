(function () {
    ...
    const LOCALES = Object.freeze({
        'zh-TW': {
            'options.bundledPresets': '內建面板',
            'options.presetCompact': '精簡播放',
            'options.presetCompactDescription': '小面板保留曲名、時間、來源與跳曲控制。',
            'options.presetReader': '曲目閱讀',
            'options.presetReaderDescription': '較大文字，右側固定顯示曲目列表。',
            'options.presetHint': '點選面板可預覽，再按「儲存並套用」。內建面板隨擴充功能提供，隨時可重新載入。',
            'options.presetLoaded': '已載入內建面板。按「儲存並套用」即可用於 YouTube。',
            languageName: '繁體中文',
        ...
        en: {
            'options.bundledPresets': 'Built-in panels',
            'options.presetCompact': 'Compact playback',
            'options.presetCompactDescription': 'A small panel with title, time, sources, and track controls.',
            'options.presetReader': 'Tracklist reader',
            'options.presetReaderDescription': 'Larger text with a persistent tracklist on the right.',
            'options.presetHint': 'Load a panel to preview it, then Save and apply. These panels ship with the extension and are always available.',
            'options.presetLoaded': 'Built-in panel loaded. Save and apply to use it on YouTube.',
        ...
        ja: {
            'options.bundledPresets': '内蔵パネル',
            'options.presetCompact': 'コンパクト再生',
            'options.presetCompactDescription': '曲名、時間、ソース、曲送りを小さなパネルに配置。',
            'options.presetReader': 'トラックリスト表示',
            'options.presetReaderDescription': '文字を大きくし、右側にトラックリストを常時表示。',
            'options.presetHint': 'パネルを選んでプレビューし、「保存して適用」を押してください。内蔵パネルはいつでも読み込めます。',
            'options.presetLoaded': '内蔵パネルを読み込みました。「保存して適用」で YouTube に反映します。',
